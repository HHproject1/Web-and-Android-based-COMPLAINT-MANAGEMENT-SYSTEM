...
<html lang="en">
  <head>
    ...
    <title>YNJGY | Complaint Details</title>
...
<?php include('includes/sidebar.php');?>
 ...
 <?php $query=mysqli_query($con,"select tblcomplaints.*,campus.campusName as catname from tblcomplaints join campus on campus.id=tblcomplaints.campus where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
...
<label class="col-sm-2 col-sm-2 control-label"><b>dorm & place :</b> </label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['dormplace']);?></p>
              </div>
            </div>
...
<label class="col-sm-2 col-sm-2 control-label"><b>occupation :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['occupation']);?></p>
              </div>
            </div>  
