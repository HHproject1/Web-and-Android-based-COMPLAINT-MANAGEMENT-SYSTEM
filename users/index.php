...
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE idNumber='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$query=mysqli_query($con,"SELECT * FROM users WHERE idNumber='$idno' and contactNo='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update users set password='$password' WHERE idNumber='$idno' and contactNo='$contact' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid idno id or Contact no";
}
}
?>
...
<input type="text" name="idno" placeholder="idno" autocomplete="off" class="form-control" required><br >
