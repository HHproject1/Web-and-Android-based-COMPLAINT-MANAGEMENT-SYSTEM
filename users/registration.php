...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,idNumber,password,contactNo,status) values('$fullname','$idno','$password','$contactno','$status')");
...
<html lang="en">
  <head>
    ...
    <title>YNJGY | User Registration</title>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <input type="text" class="form-control" maxlength="12" placeholder=" ID" id="idno" onBlur="userAvailability()" name="idno" required="required">
